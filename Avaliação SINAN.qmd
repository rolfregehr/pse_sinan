...
<iframe src="graf_tipo.html" width="100%" height="800px" frameborder="0"></iframe>
...
![Distribuição de Ocorrências de Violência por Idade, Gênero e Tipo](graf_idade_genero_tipo.svg){#fig-violencia-idade fig-align="center" width="80%"}

![Distribuição de Ocorrências de Violência por Idade, Gênero e Tipo](graf_idade_racacor_tipo.svg){#fig-violencia-idade fig-align="center" width="80%"}

![Distribuição de Ocorrências de Violência por Idade, Gênero e Tipo](graf_idade_tipo_racacor.svg){#fig-violencia-idade fig-align="center" width="80%"}
